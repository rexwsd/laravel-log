...
namespace Laravel\Log\Monolog;

use Larave\Log\Contracts\Logging\ILog;
use Throwable;
...
class LogManager extends Manager implements ILog
{
	/**
	 * @var array
	 */
     ...
     * Notes: 重写获取日志方式
     * @param null $logger
     * @return $this|mixed|ILog
     * @throws \Illuminate\Contracts\Container\BindingResolutionException
     * @author: Rex.栗田庆
     * @Date: 2020-07-19
     * @Time: 19:48
     */
	public function makeLogger($logger = null)
	{
		if (empty($logger)) {
			return $this;
		}
